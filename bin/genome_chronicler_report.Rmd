...
|    It is important to note that in most cases genomic data is probabilistic, not deterministic- i.e. having a genetic
predisposition for a disease is not a diagnosis; rather, it shows an increased likelihood of developing that disease. Also, one person can have both potentially beneficial and harmful variants in the same gene, or associated with the same disease.
